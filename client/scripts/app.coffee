...
.config([
    ...
    ($stateProvider, $urlRouterProvider) ->
       ...
       $stateProvider
          ...
          .state('a.profile', {abstract : true, url : '/profile', templateUrl : 'views/user/edit-profile.html'})
          .state('a.profile.basic', {url : '/basic',templateUrl : 'views/user/basic.html'})
          .state('a.profile.more', {url : '/more-detail',templateUrl : 'views/user/more.html'})
          .state('a.profile.pics', {url : '/picture',templateUrl : 'views/user/picture.html'})
          ...
          .state('a.single-member.profile', {url : '/profile', templateUrl : 'views/my/profile.html'})
          .state('a.single-member.groups', {url : '/groups', templateUrl : 'views/my/groups.html'})
          .state('a.my-group.joined', {url : '/i-joined', templateUrl : 'views/my/groups-joined.html'})
          .state('a.my-group.owed', {url : '/i-owed', templateUrl : 'views/my/groups-owed.html'})
          .state('a.single-member.people', {url : '/members', templateUrl : 'views/my/people.html'})
          .state('a.my-people.followers', {url : '/followers', templateUrl : 'views/my/people-followers.html'})
          .state('a.my-people.following', {url : '/following', templateUrl : 'views/my/people-following'})
          .state('a.single-member.shelf', {url : '/shelf', templateUrl : 'views/my/shelf.html'})
          .state('a.my-shelf.read', {url : '/have-read', templateUrl : 'views/my/shelf-have-read.html'})
          .state('a.my-shelf.reading', {url : '/reading', templateUrl : 'views/my/shelf-reading'})
          .state('a.my-shelf.plan', {url : '/plan-to-read', templateUrl : 'views/my/shelf-plan-to-read.html'})
          .state('a.single-member.works', {url : '/works', templateUrl : 'views/my/works.html'})
